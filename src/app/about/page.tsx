...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/aditya-singh-024553375?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    content: "/aditya-singh-024553375",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Aditya-singh9082",
    content: "/Aditya-singh9082",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Aditya Singh</p>
